...
(function Tutorial$Members () {
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0A.Fusee.Tutorial.Core.Drive)) ();
  };
  var $T0B = function () {
  ...
  function Tutorial_Main () {
    ...
    var drive = new ($T0A())();
    drive.RenderCanvas$CanvasImplementor$value = new ($T0C())();
    drive.RenderCanvas$ContextImplementor$value = new ($T0D())(drive.RenderCanvas$CanvasImplementor$value);
    $T0E().AddDriverImp(new ($T0F())(drive.RenderCanvas$CanvasImplementor$value));
    drive.Run();
  }; 
