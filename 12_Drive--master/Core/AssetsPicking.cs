...
namespace Fusee.Tutorial.Core
{
    public class AssetsPicking : RenderCanvas
    {
        ...
        SceneContainer CreateScene()
        {
            ...
            _carTransform = new TransformComponent // base Transform in _carTransform Componenten ändern ?
            {
			...
			_trailerTransform = new TransformComponent // base Transform in _carTransform Componenten ändern ?
			{
				Rotation = new float3(0, 0, 0),
				Scale = new float3(1, 1, 1),
				Translation = new float3(0, 0, -d)
			};
