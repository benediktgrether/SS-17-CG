...
(function Tutorial$Members () {
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0A.Fusee.Tutorial.Core.FirstSteps)) ();
  };
  var $T0B = function () {
  ...
  function Tutorial_Main () {
    ...
    var firstSteps = new ($T0A())();
    firstSteps.RenderCanvas$CanvasImplementor$value = new ($T0C())();
    firstSteps.RenderCanvas$ContextImplementor$value = new ($T0D())(firstSteps.RenderCanvas$CanvasImplementor$value);
    $T0E().AddDriverImp(new ($T0F())(firstSteps.RenderCanvas$CanvasImplementor$value));
    firstSteps.Run();
  }; 
